...
export default function HomePage() {
  ...
  return (
    <div className={`min-h-screen ${
      dark
        ? "bg-gradient-to-tr from-zinc-950 via-gray-900 to-zinc-900 text-white"
      ...
      <nav className="sticky top-0 z-10 flex items-center justify-between mx-auto mt-6 mb-8 max-w-6xl p-4 rounded-xl
        ...
        dark:from-zinc-800/90 dark:via-zinc-900/80 dark:to-zinc-950/80
        backdrop-blur border border-white/20 shadow-xl">
        <Link href="/" className="tracking-wide text-2xl font-extrabold text-white bg-white/10 px-4 py-1 rounded-xl">Portfolio</Link>
        <button
          className="border border-white/40 rounded-xl px-5 py-1 bg-gradient-to-r from-violet-500 via-indigo-500 to-blue-600 shadow hover:from-indigo-700 hover:to-violet-700 transition font-bold text-white"
          onClick={() => setDark((d) => !d)}
        >
      ...
      <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="mx-auto mb-12 max-w-3xl">
        <div className="p-8 rounded-2xl bg-gradient-to-r from-indigo-800/30 via-blue-900/30 to-violet-800/30
            dark:from-zinc-800/80 dark:via-zinc-900/60 dark:to-zinc-900/80
          ...
          <div className="mb-4">
            <a href="/resume.pdf" download className="inline-flex items-center px-6 py-2 rounded-xl
              ...
              dark:from-zinc-800 dark:via-zinc-900 dark:to-violet-900
              text-white hover:from-violet-500 hover:to-indigo-600 shadow border border-white/20 backdrop-blur transition font-bold">
              <span className="mr-2">Download CV</span>
              <img src="https://cdn-icons-png.flaticon.com/512/337/337946.png" alt="Download" className="w-5 h-5" />
            </a>
          </div>
          <div className="flex justify-center gap-3 mb-2">
            <a href="mailto:clementvsc.martin@gmail.com" className="px-5 py-2 rounded-xl border border-violet-300 text-violet-200 dark:text-zinc-300 dark:border-zinc-600 hover:bg-violet-100 dark:hover:bg-zinc-700 hover:text-violet-800 transition font-bold shadow backdrop-blur">Email Me</a>
            <a href="https://www.linkedin.com/in/sahaya-clement/" target="_blank" rel="noreferrer" className="px-5 py-2 rounded-xl border border-violet-300 text-violet-200 dark:text-zinc-300 dark:border-zinc-600 hover:bg-violet-100 dark:hover:bg-zinc-700 hover:text-violet-800 transition font-bold shadow backdrop-blur">LinkedIn</a>
            <a href="https://github.com/Clementvsc" target="_blank" rel="noreferrer" className="px-5 py-2 rounded-xl border border-violet-300 text-violet-200 dark:text-zinc-300 dark:border-zinc-600 hover:bg-violet-100 dark:hover:bg-zinc-700 hover:text-violet-800 transition font-bold shadow backdrop-blur">GitHub</a>
          </div>
        </div>
      </motion.div>
      ...
      <motion.section initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.5 }} className="max-w-6xl mx-auto my-10 grid md:grid-cols-2 gap-8">
        <div className="p-6 rounded-xl bg-gradient-to-br from-indigo-800/30 via-blue-900/30 to-violet-800/30 dark:from-zinc-800/80 dark:via-zinc-900/60 dark:to-zinc-900/80 backdrop-blur-lg border border-white/20 shadow-xl">
        ...
        <div className="grid grid-cols-2 gap-x-6 gap-y-5">
          {skills.map(skill => (
            <div key={skill.name} className="mb-1">
              ...
              <div className="w-full h-2 rounded-xl bg-white/10 border border-white/20 shadow backdrop-blur my-2 dark:bg-zinc-700/60 dark:border-zinc-500">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {repos.map(repo => (
              <motion.div key={repo.id} whileHover={{ scale: 1.03, boxShadow: "0 6px 48px rgba(64,0,128,0.2)" }}
                className="bg-gradient-to-br from-indigo-800/40 via-blue-900/40 to-violet-800/40 dark:from-zinc-900/80 dark:via-zinc-900/80 dark:to-zinc-800/70 rounded-xl p-6 transition shadow-lg border border-white/20 dark:border-zinc-600 backdrop-blur-lg">
      ...
      <motion.section initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.7 }} className="max-w-5xl mx-auto my-10">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {testimonials.map(test => (
            <motion.div key={test.name} whileHover={{ scale: 1.02 }} className="bg-gradient-to-r from-indigo-900/30 to-violet-900/30 dark:from-zinc-800/70 dark:to-zinc-900/70 p-6 rounded-xl shadow-lg border border-white/20 dark:border-zinc-600 backdrop-blur">
      ...
      <motion.section initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.7 }} className="max-w-5xl mx-auto my-10">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {blogs.map(blog => (
            <div key={blog.title} className="p-6 rounded-xl bg-gradient-to-r from-indigo-900/30 to-violet-900/30 dark:from-zinc-800/70 dark:to-zinc-900/70 shadow-lg border border-white/20 dark:border-zinc-600 backdrop-blur">
      ...
      <motion.section initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.7 }} id="contact" className="max-w-3xl mx-auto my-10">
        ...
        <form className="flex flex-col gap-3 p-6 rounded-xl bg-gradient-to-r from-indigo-900/30 to-violet-900/30 dark:from-zinc-800/70 dark:to-zinc-900/70 shadow-lg border border-white/20 dark:border-zinc-600 backdrop-blur-lg">
      ...
      {/* Glass Footer */}
      <footer className="mx-auto mt-12 mb-4 max-w-4xl text-center p-6 rounded-xl bg-gradient-to-r from-indigo-800/30 via-blue-900/30 to-violet-800/30 dark:from-zinc-800/70 dark:via-zinc-900/70 dark:to-zinc-900/70 backdrop-blur border border-white/20 dark:border-zinc-600 shadow text-sm text-indigo-300 dark:text-blue-400">
